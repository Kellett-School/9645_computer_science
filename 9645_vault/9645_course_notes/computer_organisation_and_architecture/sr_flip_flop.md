...
The SR flip flop is a very simple way to arrange logic gates to create a simple block of [[memory]]. However the SR flip flop has issues, for instance it can get into an **invalid state** where $Q$ and $\overline Q$ are the same, this should not be able to happen.
...
## SR Flip Flop (NOR Version) (Active High)
...
| CLK | $R$ | $S$ | $Q_{n+1}$ | $\overline Q_{n+1}$ |     State     |
| :-: | :-: | :-: | :-------: | :-----------------: | :-----------: |
|  ▲  |  0  |  0  |   $Q_n$   |   $\overline Q_n$   |     Store     |
|  ▲  |  0  |  1  |     1     |          0          |      Set      |
|  ▲  |  1  |  0  |     0     |          1          |     Reset     |
